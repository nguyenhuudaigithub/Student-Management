...
<head>
    ...
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/bootstrap.bundle.min.js') }}">
    </script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/jquery.easing.min.js') }}"></script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/waypoints.min.js') }}"></script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/jquery.counterup.min.js') }}">
    </script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/moment.min.js') }}"></script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('template/plain-free-bootstrap-admin-template-main/assets/js/app.js') }}"></script>
            ...
            <ul>
                ...
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul id="ddmenu_2" class="collapse dropdown-nav">
                        <li>
                            <a href="admin/users"> UserManager </a>
                        </li>
                        <li>
                            ...
                            <div class="notification-box ml-15 d-none d-md-flex">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                                    <li>
                                        <a href="#0">
                                            <div class="image">
                                                <img src="{{ asset('assets/images/lead/lead-6.png') }}"
                                                    alt="" />
                                    ...
                                    <li>
                                        <a href="#0">
                                            <div class="image">
                                                <img src="{{ asset('assets/images/lead/lead-1.png') }}"
                                                    alt="" />
                                            </div>
                                            <div class="content">
                                                <h6>
                            ...
                            <div class="header-message-box ml-15 d-none d-md-flex">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                                    <li>
                                        <a href="#0">
                                            <div class="image">
                                                <img src="{{ asset('assets/images/lead/lead-5.png') }}"
                                                    alt="" />
                                    ...
                                    <li>
                                        <a href="#0">
                                            <div class="image">
                                                <img src="{{ asset('assets/images/lead/lead-3.png') }}"
                                                    alt="" />
                                    ...
                                    <li>
                                        <a href="#0">
                                            <div class="image">
                                                <img src="{{ asset('assets/images/lead/lead-2.png') }}"
                                                    alt="" />
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product">
                                                    <div class="image">
                                                        <img src="{{ asset('assets/images/products/product-mini-1.jpg') }}"
                                                            alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product">
                                                    <div class="image">
                                                        <img src="{{ asset('assets/images/products/product-mini-2.jpg') }}"
                                                            alt="">
                                                        alt="" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="product">
                                                    <div class="image">
                                                        <img src="{{ asset('assets/images/products/product-mini-4.jpg') }}"
                                                            alt="">
